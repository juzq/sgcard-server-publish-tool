...
class PublishTool ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"苍龙测试服发布工具V1.5.3", pos = wx.DefaultPosition, size = wx.Size( 551,417 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL )
		...
		self.menu_item_history = wx.MenuItem( self.menu_chio, wx.ID_ANY, u"发布历史", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_chio.Append( self.menu_item_history )

		self.menu_item_edit_info = wx.MenuItem( self.menu_chio, wx.ID_ANY, u"信息修改", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_chio.Append( self.menu_item_edit_info )

		self.menu_bar.Append( self.menu_chio, u"选项(S)" )

		self.menu_help = wx.Menu()
		self.menu_item_update = wx.MenuItem( self.menu_help, wx.ID_ANY, u"更新说明", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_help.Append( self.menu_item_update )
		...
		choi_srvChoices = [ u"游戏1服", u"游戏2服", u"战斗服", u"列表服" ]
		...
		fgSizer38.Add( fgSizer41, 1, wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.Bind( wx.EVT_MENU, self.his_select, id = self.menu_item_history.GetId() )
		self.Bind( wx.EVT_MENU, self.edit_info_select, id = self.menu_item_edit_info.GetId() )
		...
		self.maven_picker.Bind( wx.EVT_DIRPICKER_CHANGED, self.event_jdk_changed )
